...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Albyei Corp Engineering",
            "email": "dev@albyeicorp.com"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.AddRoleRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.LoginRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Full name (min 3, max 100)",
                        "name": "name",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Password (min 8, must contain special char)",
                        "name": "password",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/candidate/applications/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "New CV file (optional)",
                        "name": "cv",
                        "in": "formData"
                    }
                ],
        ...
        "/hiring_manager/jobs": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Job title (min 10, max 200)",
                        "name": "title",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Job description (min 50)",
                        "name": "description",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/hiring_manager/jobs/{id}/publish": {
            "patch": {
                "security": [
                    {
                        "Bearer": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.UpdateStatusRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.CreateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.UpdateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.RejectJobRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/hr/news-cultures": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Article title (min 5, max 200)",
                        "name": "title",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Article content (min 20)",
                        "name": "content",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Short excerpt (max 500)",
                        "name": "excerpt",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/hr/news-cultures/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "New gallery images",
                        "name": "gallery",
                        "in": "formData"
                    }
                ],
        ...
        "/jobs/{slug}/apply": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "WhatsApp number (08xx format)",
                    ...
                    {
                        "type": "string",
                        "description": "Province of domicile",
                    ...
                    {
                        "type": "file",
                        "description": "CV file (PDF, max 5MB)",
                        "name": "cv",
                        "in": "formData",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/wowrack-recruitment_internal_dto.DeleteMyAccountRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "internal_handlers.AddRoleRequest": {
            "type": "object",
            "required": [
                "role"
            ],
        ...
        "wowrack-recruitment_internal_dto.CreateDepartmentRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "wowrack-recruitment_internal_dto.DeleteMyAccountRequest": {
            "type": "object",
            "required": [
                "password"
            ],
        ...
        "wowrack-recruitment_internal_dto.LoginRequest": {
            "type": "object",
            "required": [
                "email",
                "password"
        ...
        "wowrack-recruitment_internal_dto.RejectJobRequest": {
            "type": "object",
            "required": [
                "reason"
            ],
        ...
        "wowrack-recruitment_internal_dto.UpdateDepartmentRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
        ...
        "wowrack-recruitment_internal_dto.UpdateStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
            "properties": {
                "duration_minutes": {
                    "description": "wajib jika status interview, misal 60",
                    "type": "integer"
                },
                "interview_date": {
                    "description": "wajib jika status interview",
                    "type": "string"
                },
                "notes": {
                    "type": "string"
